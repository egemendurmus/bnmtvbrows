...
public class SeriesCatGridList extends AppCompatActivity {
    GridView gridview;
...
//        getSupportActionBar().hide();
        ...
        urlString = "http://" + MainActivity.MainUrl + ":" + MainActivity.MainPort + "/player_api.php?username=" + MainActivity.userName + "&password=" + MainActivity.password + "&action=get_series_categories";
        new GetChannelCategory().execute();
        Button b6 = findViewById(R.id.button6);
        b6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SeriesCatGridList.this, infoActivity.class);
                startActivity(i);
            }
        });
        ...
        inMenuArama.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (aramall.getVisibility() == View.INVISIBLE || aramall.getVisibility() == View.GONE) {
                    ...
                    isKeyBoardOpen(SeriesCatGridList.this);
                }else{
    ...
    public boolean dispatchKeyEvent(KeyEvent e) {
        ...
        try {
            ...
            if (e.getKeyCode() == KeyEvent.KEYCODE_MENU) {
                Intent i = new Intent(SeriesCatGridList.this, VodORStreamActivity.class);
                startActivity(i);
                finish();
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pass.equals("2580")) {
                    ...
                    Intent is = new Intent(SeriesCatGridList.this, SeriesChannelGridList.class);
                    startActivity(is);
                } else {
                    Toast.makeText(SeriesCatGridList.this, "Yanlış Şifre Girdiniz Lütfen Tekrar Deneyiniz", Toast.LENGTH_LONG).show();
                }
    ...
    private class GetChannelCategory extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SeriesCatGridList.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            final GridOzelAdapter adaptorumuz = new GridOzelAdapter(SeriesCatGridList.this, channelList);
            ...
            if (adaptorumuz.getCount() == 0) {
                ...
                Intent i = new Intent(SeriesCatGridList.this, MainActivity.class);
                startActivity(i);
            } else {
            ...
            gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (kisi.getCategoryName().equals("FOR ADULTS")) {
                        SeriesFilmList.channelCatID = kisi.getCategoryID();

                        showDialog(SeriesCatGridList.this, null);
                    } else {
                      /*  if(kayıtlı_kullanıcı("tip").equals("liste")){
                            SeriesFilmList.channelCatID = kisi.getCategoryID();

                            Intent is = new Intent(SeriesCatGridList.this, SeriesFilmList.class);
                            startActivity(is);
                        }else  if(kayıtlı_kullanıcı("tip").equals("grid")){
                            ChannelListActivity.channelCatID = kisi.getCategoryID();
