...
import com.mobilfabrikator.goaltivibrowser.SeriesPack.SeriesFilmList;
...
public class SeriesCatList extends Activity {
...
//    private static String urlString = "http://iptv.nexa.space:8000/player_api.php?username=egementst&password=564fdtr&action=get_live_categories";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlString = "http://"+MainActivity.MainUrl+":"+MainActivity.MainPort+"/player_api.php?username="+
                MainActivity.userName+"&password="+MainActivity.password+"&action=get_series_categories";
        ...
        bilgi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SeriesCatList.this, infoActivity.class);
                startActivity(i);
            }
        });
    ...
    private class GetChannelCategory extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SeriesCatList.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            OzelAdapter adaptorumuz = new OzelAdapter(SeriesCatList.this, channelList);
            ...
            if(adaptorumuz.getCount()==0){
                ...
                Intent i = new Intent(SeriesCatList.this,MainActivity.class);
                startActivity(i);
            }else{
            ...
            if(kayıtlı_kullanıcı("tip").equals("grid")){
                Toast.makeText(SeriesCatList.this,
            ...
            public void onClick(View v) {
                ...
                if(pass.equals("2580")){
                    if(kayıtlı_kullanıcı("tip").equals("liste")){
                        ...
                        Intent is = new Intent(SeriesCatList.this, SeriesChannelGridList.class);
                        startActivity(is);;
                    }
                }
