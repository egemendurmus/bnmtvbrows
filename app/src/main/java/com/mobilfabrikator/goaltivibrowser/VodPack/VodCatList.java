...
public class VodCatList extends Activity {
    ...
    ChannelCategoryData channelCategoryData;
//    private static String urlString = "http://iptv.nexa.space:8000/player_api.php?username=egementst&password=564fdtr&action=get_live_categories";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlString = "http://"+MainActivity.MainUrl+":"+MainActivity.MainPort+"/player_api.php?username="+MainActivity.userName+"&password="+MainActivity.password+"" +
        ...
        bilgi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(VodCatList.this, infoActivity.class);
                startActivity(i);
            }
        });
        new GetChannelCategory().execute();
      //  new GetVodCatInfo().execute();
    }
    ...
    private class GetChannelCategory extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(VodCatList.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        channelCategoryData = channelList.get(i);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            OzelAdapter adaptorumuz = new OzelAdapter(VodCatList.this, channelList);
            ...
            if(adaptorumuz.getCount()==0){
                ...
                Intent i = new Intent(VodCatList.this,MainActivity.class);
                startActivity(i);
            }else{
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if(kisi.getCategoryName().equals("FOR ADULTS")){
                        ...
                        showDialog(VodCatList.this,null);
                    }else{
                        if(kayıtlı_kullanıcı("tip").equals("liste")){
                            VodFilmList.channelCatID = kisi.getCategoryID();

                            Intent is = new Intent(VodCatList.this, VodFilmList.class);
                            startActivity(is);
                        }else  if(kayıtlı_kullanıcı("tip").equals("grid")){
                            ChannelListActivity.channelCatID = kisi.getCategoryID();

                            Intent is = new Intent(VodCatList.this, VodCatGridList.class);
                            startActivity(is);;
                        }
            ...
            if(kayıtlı_kullanıcı("tip").equals("grid")){
                Toast.makeText(VodCatList.this,
    ...
    private class GetVodCatInfo extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            // Making a request to url and getting response
            String urlCat ="http://"+MainActivity.MainUrl+":"+MainActivity.MainPort+"/player_api.php?username="+MainActivity.userName+"&password="+MainActivity.password+"" +
                    "&action=get_vod_streams";
            String jsonStr = sh.makeServiceCall(urlCat);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        String catIDs = jsonObj.getString("category_id");
                       // channelList.add(new ChannelCategoryData(catName, catID));

                            hmap.put(catIDs,catIDs);
                            hmap.size();
            ...
            public void onClick(View v) {
                ...
                if(pass.equals("2580")){
                    if(kayıtlı_kullanıcı("tip").equals("liste")){
                        ...
                        Intent is = new Intent(VodCatList.this, VodChannelGridList.class);
                        startActivity(is);;
                    }
                }
