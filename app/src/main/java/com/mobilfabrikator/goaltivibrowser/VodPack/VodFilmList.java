...
public class VodFilmList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlString = "http://" + MainActivity.MainUrl + ":" + MainActivity.MainPort + "/player_api.php?username=" +
                MainActivity.userName + "&password=" + MainActivity.password + "&action=get_vod_streams&category_id=" + channelCatID;
    ...
    public  class GetChannelCategory extends AsyncTask<Void, Void, Void> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            // Showing progress dialog
            pDialog = new ProgressDialog(VodFilmList.this);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                       ...
                       ChannelListActivity. channelList.add(new ChannelStreamData(catName, catID, imageurl));
                        ...
                        System.out.println("Title : " + i + " = " + jsonObj.getString("name"));
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            ChannelNameCategoryAdapter adaptorumuz = new ChannelNameCategoryAdapter(VodFilmList.this, channelList);
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                System.out.println(kisi.getChannelName());
    ...
    public boolean dispatchKeyEvent(KeyEvent e) {
        ...
        try {
            ...
            if (e.getKeyCode() == KeyEvent.KEYCODE_MENU) {
                Intent i = new Intent(VodFilmList.this, VodORStreamActivity.class);
                startActivity(i);
                finish();
